      ...
      <el-card shadow="never">
        <div class='organization-index'>
          ...
          <div style="overflow: scroll;white-space:nowrap" class="treBox">
                ...
                <span class="treeRinfo">
                  <div class="treeRinfo">
                    ...
                    <span>在职 <em class="colGreen" title="在职人数">---</em>&nbsp;&nbsp;(<em class="colGreen"
                        title="正式员工">---</em>&nbsp;/&nbsp;<em class="colRed" title="非正式员工">---</em>)</span>
                  </div>
                  <div class="treeRinfo">
                    <el-dropdown class="item">
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item>
                          <el-button type="text" @click="handlAddDept">添加子部门</el-button>
                        </el-dropdown-item>
                        <el-dropdown-item>
            ...
            <div class="block">
              <el-tree :props="{label:'name'}" :data="pageDepts" node-key="id" default-expand-all>
    ...
    methods: {
      ...
      getList() {
        list().then(res => {
          ...
          //将普通的数据转化为父子结构
          this.pageDepts = commonApi.transJsonformTozTreeFormat(res.data.data.depts)
        })
      }
    },
    created: function () {
